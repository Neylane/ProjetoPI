 ...
 * @author kelly silva
 */
public class PsicologaManagerHiber{

    private static PsicologaManagerHiber myself = null;

    private SessionFactory sessionFactory;
    private Session s;

    private PsicologaManagerHiber() {
    ...
    public static PsicologaManagerHiber getInstance() {
        if (myself == null) {
            myself = new PsicologaManagerHiber();
        }
